            ...
            <div className="relative mx-auto max-w-[85%] px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                <div className="flex flex-col gap-3 items-center">
                    ...
                    <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white md:leading-tight animate__animated animate__fadeInDown">
                        {language === "en" ? "Mievoh Offers & Promotions" : "Khuyến Mãi & Ưu Đãi Mievoh"}
                    </h1>
                    
                    {/* Centered Subtitle */}
                    <p className="text-sm md:text-base text-gray-350 max-w-xl leading-relaxed font-medium animate__animated animate__fadeInUp animate__delay-1s">
                        {language === "en" 
                            ? "Discover special voucher codes, select seats, and enjoy exclusive discounts on your movie tickets!" 
                            : "Khám phá các mã giảm giá đặc biệt, đặt vé xem phim ngay và tận hưởng nhiều ưu đãi độc quyền!"}
                    </p>
                </div>
            </div>
        </div>
